 ...
 * Sprawdza również czy gracz może wykonać jakikolwiek złoty ruch - bez rozspójnienia
 * obszarów przeciwników na ich niedopuszczalną liczbę.
 * @param[in] g       – wskaźnik na strukturę przechowującą stan gry,
 * @param[in] player  – numer gracza, liczba dodatnia niewiększa od wartości
 *                      @p players z funkcji @ref gamma_new.
...
/** @brief Wypisuje planszę na standardowe wyjście.
 * @param[in] g     - wskaźnik na strukturę przechowującą stan gry.
 */
